...
The devtools package makes package development easier as it provides R functions that simplify common tasks. The last two lines of the script installs the textual analysis package 'qcoder'.
