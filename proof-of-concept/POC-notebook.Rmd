...
```
rawPath builds a path to the directory holding the txt files - make sure you change this to the path of the 'proof-of-concept' folder (located on your Desktop)
